...
- (id)initWithFrame:(CGRect)frame withLower:(float)lower upper:(float)upper
{
...
//    _minimumValue = 100.0;
//    _maximumValue = 1000.0;
    _minimumRange = 50.0;
    _stepValue = 50.0;
    _stepValueInternal = 50.0;
    ...
    _lowerTouchEdgeInsets = UIEdgeInsetsMake(-12, -12, -12, -12);
...
- (UIImage *)trackBackgroundImage
{
    if(_trackBackgroundImage==nil)
    {
        ...
        {
            UIImage *image = [UIImage imageNamed:@"sliderTrackImage 2"];
...
- (UIImage *)trackImage
{
    if(_trackImage==nil)
    {
        ...
        else
        {
            ...
            UIImage* image =[UIImage imageNamed:@"sliderTrackImage2 "];
            image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 2.0, 0.0, 2.0)];
...
- (UIImage *)lowerHandleImageNormal
{
    if(_lowerHandleImageNormal==nil)
    {
        ...
        {
            UIImage *image = [UIImage imageNamed:@"sliderThumbImageSmall"];
...
- (UIImage *)upperHandleImageNormal
{
    if(_upperHandleImageNormal==nil)
    {
        ...
        {
            UIImage *image = [UIImage imageNamed:@"sliderThumbImage2"];
