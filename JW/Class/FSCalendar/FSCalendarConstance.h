...
#define FSCalendarStandardSelectionColor   FSColorRGBA(112,193,179,1.0)
#define FSCalendarStandardTodayColor       FSColorRGBA(245,166,35 ,1.0)
...
#define FSCalendarStandardSeparatorColor   [[UIColor lightGrayColor] colorWithAlphaComponent:0.0]
