...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _titleFontName = goFont13.fontName;
        _subtitleFontName = [UIFont systemFontOfSize:1].fontName;
        _weekdayFontName = goFont15M.fontName;
        _headerTitleFontName = goFont13.fontName;
        
        _headerTitleColor = goColor1;
        _headerDateFormat = @"YYYY MMM";
        _headerMinimumDissolvedAlpha = 0.2;
        _weekdayTextColor = goColor1;
